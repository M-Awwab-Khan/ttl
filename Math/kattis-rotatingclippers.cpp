...
// Optimized hull diameter using rotating calipers (O(n))
// Based on competitive programming library implementation
...
int main() {
    ...
    vector<Point<ll>> hull = convexHull(polygon);
    ...
    auto diameter_points = hullDiameter(hull);
    Point<ll> a = diameter_points[0];
    Point<ll> b = diameter_points[1];
